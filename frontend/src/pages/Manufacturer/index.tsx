...
import {addManufacturer, getManufacturer, removeManufacturer, updateManufacturer} from "@/pages/Manufacturer/api";


const handleAdd = async (fields: API.RuleListItem) => {
  const hide = message.loading('正在添加');
  try {
    await addManufacturer({ ...fields });
    hide();
...
const TableList: React.FC = () => {
  ...
  return (
    <PageContainer>
      ...
      >
        <ProFormText label="生产厂家名称" name="manufacturerName" />
        <ProFormText label="生产厂家地址" name="manufacturerAddress" />
